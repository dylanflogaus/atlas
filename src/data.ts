...
export const ballotChasers: BallotChaser[] = [
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        description: '10 follow-up visits that resulted in confirmed ballot plans',
        icon: 'task_alt',
        unlocked: true,
        tier: 'bronze',
      },
      {
        ...
        description: 'Recruited 3 local volunteers directly from turf conversations',
        icon: 'group_add',
        unlocked: true,
        tier: 'silver',
      },
      ...
      {
        id: 'amen-4',
        title: 'Grassroots giant',
        description: '250 doors logged in a single election cycle',
        icon: 'forest',
        unlocked: false,
      },
      {
        ...
        description: 'Six weekend field shifts in one month',
      ...
      },
      {
        ...
        description: 'Twenty quality contacts in a second language',
        icon: 'translate',
        unlocked: false,
      },
      {
        id: 'amen-7',
        title: 'Data disciple',
        description: 'Thirty consecutive days with same-day contact logging',
        icon: 'database',
        unlocked: false,
      },
      {
        id: 'amen-8',
        title: 'Neighbor node',
        description: 'Five warm referrals from existing supporters',
        icon: 'hub',
        unlocked: false,
      },
      {
        id: 'amen-9',
        title: 'Iron RSVP',
        description: 'Fifty confirmed turnout commitments on file',
      ...
      },
      {
        id: 'amen-10',
        title: 'Turf torch',
        description: 'Three adjacent precincts cleared in one week',
      ...
      },
      {
        id: 'amen-11',
        title: 'Mentor mode',
        description: 'Two new canvassers coached through first solo shift',
        icon: 'school',
        unlocked: false,
      },
      {
        id: 'amen-12',
        title: 'Double knock',
        description: 'Successful revisit within 48 hours on twenty doors',
        icon: 'replay',
        unlocked: false,
      },
    ],
